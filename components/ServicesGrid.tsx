      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-[#232323] mb-4">
            Roof Repair Company in <span className="text-[#FF570A]">Austin TX</span>
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <Link 
              ...
              className="group"
            >
              <div className="h-full bg-white rounded-xl border-2 border-[#E2E2E2] hover:border-[#FF570A] hover:shadow-xl transition-all duration-300 p-8">
                
                {/* Icon */}
                <div className="w-16 h-16 rounded-lg bg-[#232323] flex items-center justify-center mb-6 group-hover:bg-[#FF570A] transition-colors">
                  <Icon icon={service.icon} className="w-8 h-8 text-white" />
                </div>

                {/* Title */}
                <h3 className="font-display text-xl font-bold text-[#232323] mb-3 group-hover:text-[#FF570A] transition-colors">
                  {service.name}
                </h3>
                ...
                {/* View Service Link */}
                <div className="flex items-center gap-2 text-[#FF570A] font-semibold text-sm">
        ...
        <div className="mt-16 text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-3 px-8 py-4 bg-[#FF570A] hover:bg-[#E64D09] text-white font-bold rounded-lg transition-all shadow-lg hover:shadow-xl"
          >

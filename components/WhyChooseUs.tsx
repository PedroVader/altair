    ...
    <>
      ...
      <div className="relative py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#232323]/50 to-[#232323]/65"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {services.map((service, index) => (
              <div key={index} className="bg-white rounded-xl border-2 border-[#E2E2E2] hover:border-[#0CEBD2] hover:shadow-xl transition-all duration-300 overflow-hidden group">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={index} className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#0CEBD2] flex items-center justify-center flex-shrink-0 mt-0.5">

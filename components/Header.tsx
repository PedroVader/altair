        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <ul className="flex items-center gap-7">
              <li>
                <Link href="/" className="text-[#232323] hover:text-[#FFB343] transition-colors font-semibold text-sm cursor-pointer relative group">
                  Home
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#FFB343] group-hover:w-full transition-all duration-300"></span>
                </Link>
              </li>
              ...
              >
                <button className="flex items-center gap-1 text-[#232323] hover:text-[#FFB343] transition-colors font-semibold text-sm group">
                  Services
                  <Icon 
                  ...
                  <div className="py-2">
                    {services.map((service) => (
                      <Link
                        key={service.name}
                        href={service.href}
                        className="flex items-center gap-3 px-4 py-3 hover:bg-[#FFB343]/10 hover:text-[#232323] transition-all group cursor-pointer"
                      >
                        <div className="w-8 h-8 rounded-lg bg-[#F6F6F6] flex items-center justify-center group-hover:bg-[#FFB343] transition-colors">
              ...
              {/* Service Areas */}
              <li>
                <Link href="/locations" className="text-[#232323] hover:text-[#FFB343] transition-colors font-semibold text-sm cursor-pointer whitespace-nowrap relative group">
                  Service Areas
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#FFB343] group-hover:w-full transition-all duration-300"></span>
                </Link>
              </li>
              ...
              <li>
                <Link href="/about" className="text-[#232323] hover:text-[#FFB343] transition-colors font-semibold text-sm cursor-pointer relative group">
                  About
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#FFB343] group-hover:w-full transition-all duration-300"></span>
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-[#232323] hover:text-[#FFB343] transition-colors font-semibold text-sm cursor-pointer relative group">
                  Contact
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#FFB343] group-hover:w-full transition-all duration-300"></span>
                </Link>
              </li>
          ...
          <button 
            ...
            className="lg:hidden text-[#232323] hover:text-[#FFB343] transition-colors cursor-pointer"
          >
            <Icon 
        ...
        >
          <ul className="space-y-2 pt-4">
            <li>
              <Link 
                href="/" 
                className="block px-4 py-3 text-[#232323] hover:bg-[#FFB343]/10 hover:text-[#232323] rounded-xl transition-all text-base font-semibold cursor-pointer"
                  ...
                  {services.map((service) => (
                    <li key={service.name}>
                      <Link
                        ...
                        onClick={() => setMobileMenuOpen(false)}
                      >
                        <Icon icon={service.icon} className="w-4 h-4 text-[#FFB343]" />
                        {service.name}
                      </Link>
                    </li>
                  ))}
                  ...
                  {roofTypes.map((type) => (
                    <li key={type.name}>
                      <Link
                        ...
                        onClick={() => setMobileMenuOpen(false)}
                      >
                        <Icon icon={type.icon} className="w-4 h-4 text-[#FFB343]" />
                        {type.name}
                      </Link>
                    </li>
                  ))}

...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'About Us | Altair Austin Roofing',
    description: 'Over 15 years of excellence in residential roofing. Licensed, insured, and trusted by hundreds of homeowners.',
    type: 'website',
    url: 'https://altairaustin.com/about',
    images: [
      {

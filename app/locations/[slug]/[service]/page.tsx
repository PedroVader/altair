    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-50 py-4 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <Link href={`/locations/${location.slug}`} className="hover:text-[#00529C] transition-colors">
              {location.name}
            </Link>
            <Icon icon="mdi:chevron-right" className="w-4 h-4" />
            <span className="text-[#00529C] font-semibold">{item.name}</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative py-12 md:py-16 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt={`${item.name} in ${location.name}`}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-[#00529C] mb-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
            ...
            <div className="bg-[#00529C]/5 border-l-4 border-[#FFE317] p-6 rounded-r-lg mt-8">
              <p className="text-[#00529C] font-semibold mb-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            {allRoofTypes.map((roofTypeItem) => (
              <Link
                ...
                className="group"
              >
                <div className="h-full bg-white rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 border-2 border-gray-200 hover:border-[#00529C] overflow-hidden">
                  <div className="p-4 sm:p-6 text-center flex flex-col items-center min-h-[220px]">
                    <div className="mb-3 text-gray-700 group-hover:text-[#00529C] transition-colors duration-300">
                      <Icon icon={roofTypeItem.icon} className="w-10 h-10 sm:w-12 sm:h-12" />
                    </div>
                    <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-2 group-hover:text-[#00529C] transition-colors duration-300">
                      {roofTypeItem.name}
                    </h3>
                    <p className="text-gray-600 text-xs sm:text-sm leading-relaxed flex-grow line-clamp-3">
                      {roofTypeItem.shortDescription}
                    </p>
                    <div className="flex items-center gap-1 text-[#00529C] font-semibold text-xs sm:text-sm group-hover:gap-2 transition-all duration-300 mt-3">
                      <span>Learn More</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {allLocations.map((locationItem) => (
              ...
              >
                ...
                <p className="font-semibold text-gray-900 text-sm group-hover:text-[#00529C] transition-colors">{locationItem.name}</p>

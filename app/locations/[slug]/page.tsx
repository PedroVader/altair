...
export async function generateMetadata({ 
  ...
  return {
    title: `${location.name} Roofing Services | Altair Austin Roofing - Local Experts`,
    description: `${location.description} Professional roofing services in ${location.name}, TX. Licensed, insured, and trusted by local homeowners. Free estimates available.`,
    keywords: `roofing ${location.name}, ${location.name} roofer, roof repair ${location.name}, roof replacement ${location.name} TX, roofing contractor ${location.name}`,
    openGraph: {
      title: `${location.name} Roofing Services | Altair Austin Roofing`,
      description: location.description,
      type: 'website',
      locale: 'en_US',
      url: `https://altairaustin.com/locations/${location.slug}`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `Roofing Services in ${location.name}, TX`,
        },
      ],
    },
    twitter: {
      card: 'summary_large_image',
      title: `${location.name} Roofing Services`,
      description: location.description,
    },
  };
}

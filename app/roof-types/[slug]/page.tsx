  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="bg-gray-50 py-4 border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span className="text-[#FFB343] font-semibold">{roofType.name}</span>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <div key={index} className="bg-white rounded-xl p-6 hover:shadow-xl transition-all duration-300 border-2 border-gray-200 hover:border-[#FFB343] group">
                  <div className="w-14 h-14 bg-[#FFB343] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <Icon icon={service.icon} className="w-7 h-7 text-[#232323]" />
                  </div>
                  {/* H3 para cada servicio */}
                  <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#FFB343] transition-colors">
                    {service.title}
                  </h3>
        ...
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold text-[#232323] mb-6">
              Key Specifications
            </h2>
            <div className="space-y-3">
              {roofType.averageLifespan && (
                <div className="flex items-start gap-3">
                  <Icon icon="mdi:check-circle" className="w-6 h-6 text-[#FFB343] flex-shrink-0 mt-0.5" />
                  <div>
        ...
        {(roofType.pros || roofType.cons) && (
          <section className="py-12 bg-gray-50">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-2xl md:text-3xl font-bold text-[#232323] mb-8 text-center">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                {roofType.pros && roofType.pros.length > 0 && (
                  <div>
                    <h3 className="text-xl font-bold text-[#FFB343] mb-6">
                      Advantages
                    </h3>
                    <ul className="space-y-3 text-gray-700">
                      {roofType.pros.map((pro, idx) => (
                        <li key={idx} className="flex items-start">
                          <span className="mr-3 text-[#FFB343] font-bold">•</span>
                          <span>{pro}</span>
                        </li>
                      ))}
                    </ul>
        ...
        {/* Why Choose Us Section - H2 con video */}
        <section className="relative py-16 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none text-white leading-relaxed space-y-4 drop-shadow-md">
              <p>
                If you are a resident of <strong className="text-[#FFB343]">Texas</strong>, then odds are you're already aware of just how much damage the weather conditions can be to your home or property. This is something that we keep in mind when it comes to installing {roofType.name.toLowerCase()} in <strong className="text-[#FFB343]">Austin and surrounding areas</strong>.
              </p>
              <p>
              ...
              <p>
                So what are you waiting for? If you are based in <strong className="text-[#FFB343]">Austin</strong> then do not hesitate to get in touch with our team at <strong className="text-[#FFB343]">Altair Austin Roofing</strong> today. To discuss all of your {roofType.name.toLowerCase()} needs, simply give us a call to speak with one of our team members. What's more, we even offer a <strong className="text-[#FFB343]">free estimate service</strong> so that you can get an idea of what you need before the work begins on your roofing project.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                {roofType.name} Installation Throughout <span className="text-[#FFB343]">Austin</span>
              </h2>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {/* FAQ 1 */}
              <details open className="bg-white rounded-xl p-6 border-2 border-gray-200 hover:border-[#FFB343] shadow-sm group">
